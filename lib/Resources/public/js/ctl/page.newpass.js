                ...
                reset : new ag.app.View({
                    ...
                    main : new ag.ui.ctxt.Container({
                        ...
                        form : new ag.app.Form(
                            ...
                            function(res, status) { if (status === 200) ag.s.state.switchTo("/thanks"); },
                            ag.u.tpl("ag-app-form", ".form-footer.simple")
                        )
                    })
                }),

                thanks : new ag.app.View({
                    h : new ag.app.Title(ag.intl.t("Password update")),
                    main : new ag.ui.ctxt.Container({
